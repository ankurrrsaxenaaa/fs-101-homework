...
public class GuestBookServiceTest {
    ...
    @Test
    public void should__be_able_to_save_when_ip_address_is_new() {
    ...
    @Test
    public void should_be_able_to_throw_exception_when_ip_address_is_redundant() {
        GuestBookEntry guestBookEntry = new GuestBookEntry( "Shekhar", "Shekhar is busy today" );
        GuestBookService guestBookService = new GuestBookService( new CacheUtility() );
        guestBookService.createAndSaveEntry( guestBookEntry, "121" );
        try {
    ...
    @Test
    public void should_be_able_to_throw_exception_when_there_is_spam_in_content() {
    ...
    @Test
    public void should__be_able_to_share_the_post_if_ip_is_new_and_content_does_not_contain_spam() {
