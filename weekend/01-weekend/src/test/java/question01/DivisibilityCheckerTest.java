...
public class DivisibilityCheckerTest {
    ...
    @Test
    public void should_return_list_of_size_one_when_x_and_y_are_equal_and_divisible_by_seven_and_are_not_a_multiple_of_five(){
    ...
    @Test
    public void should_return_list_of_size_zero_when_x_and_y_are_equal_and_divisible_by_seven_and_are_a_multiple_of_five(){
    ...
    @Test
    public void should_return_list_of_integers_when_x_is_smaller_than_y_and_divisible_by_seven_and_are_not_a_multiple_of_five(){
